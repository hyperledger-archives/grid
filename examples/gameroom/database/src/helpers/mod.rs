...
pub use gameroom::{
    ...
    fetch_gameroom_proposal_with_status, fetch_proposal_by_id, gameroom_service_is_active,
    get_gameroom_count, get_proposal_count, insert_gameroom, insert_gameroom_members,
