...
ALTER TABLE associated_agent DROP COLUMN source;

ALTER TABLE grid_property_definition DROP COLUMN source;

ALTER TABLE grid_schema DROP COLUMN source;

ALTER TABLE organization DROP COLUMN source;

ALTER TABLE product DROP COLUMN source;

ALTER TABLE product_property_value DROP COLUMN source;

ALTER TABLE property DROP COLUMN source;

ALTER TABLE proposal DROP COLUMN source;

ALTER TABLE record DROP COLUMN source;

ALTER TABLE reported_value DROP COLUMN source;

ALTER TABLE reporter DROP COLUMN source;
